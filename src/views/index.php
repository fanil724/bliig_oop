            ...
            <div id="templatemo_content">
                <?php foreach ($posts as $post): ?>
                    <div class="post_section"><span class="bottom"></span>
                        ...
                        <span class="comment"><a href="/?c=posts&a=post&id=<?= $post['id'] ?>">65</a></span>

                        <h2><a href="/?c=posts&a=post&id=<?= $post['id'] ?>"><?= $post['title'] ?></a></h2>
                        ...
                        <div class="category">Tags: <a href="#"><?= $post['id_category'] ?></a>, <a href="#">Templates</a></div>
